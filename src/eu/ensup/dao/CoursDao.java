...
public class CoursDao extends BaseDao implements ICoursDao {
    @Override
    public int addCours(Cours cours) throws DatabaseException {
        try {
            connexion();
            ...
            throw new DatabaseException("Le cour n'a pu être ajouter");
        }
        disconnect();
    ...
    @Override
    public int updateCours(Cours cours) throws DatabaseException {
        try {
            connexion();
    ...
    @Override
    public int deleteCours(Cours cours) throws DatabaseException {
        String sql;
        try {
            connexion();
            ...
            throw new DatabaseException("Le cour n'a pu être supprimer");
        }
        disconnect();
        return BaseDao.getResult();
    ...
    @Override
    public Cours getCours(int id) throws DatabaseException {
        String sql;
        ...
        try {
            ...
            throw new DatabaseException("On ne peut pas obtenir le cours");
        }
        disconnect();
        return null;
    }
    ...
    public List<Cours> findAll() throws DatabaseException {
        ...
        try {
            ...
            throw new DatabaseException("Tous les cours ne sont pas disponible");
        }
        disconnect();
        return cours;
    }
    ...
    @Override
    public int inscription(Cours c, Etudiant e) throws DatabaseException {
        ...
        try {
            ...
            throw new DatabaseException("L'étudiant n'a pas étais inscrit au cours");
        }
        disconnect();
        return getResult();
    ...
    @Override
    public List<Cours> getCoursEtudiant(int idEtudiant) throws DatabaseException {
        // TODO Auto-generated method stub
